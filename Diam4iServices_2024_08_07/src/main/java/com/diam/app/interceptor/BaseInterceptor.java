...
import com.diam.app.esb.Helper;
import com.diam.app.esb.IConstants;
import com.diam.app.filters.AuthenticationFilter;
import com.diam.app.filters.GetDetails;
import com.diam.app.model.TXNAuditLogs;
import com.diam.app.processors.ExceptionProcessor;
import com.diam.app.utils.DBUtils;
...
public class BaseInterceptor implements HandlerInterceptor{
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		System.out.println("URI" + s +" : "+request.getHeader("Content-Type"));
        ...
        System.out.println("Trust Store Path - End of Prehandle: " + trustStorePath);
        System.out.println("Trust Store Password: - End of Prehandle: " + trustStorePassword);
		return false;
	}
