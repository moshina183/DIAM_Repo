...
@Service
public class DiamServiceVer2 {
	
private static final Logger logger = LoggerFactory.getLogger(DiamServiceVer2.class);
	...
	public ResponseEntity<String> getBilldataServiceHandler(String billId, String ccbAccount) {
		
		System.out.println("--Begin getBilldataServiceHandler method----");
		HttpHeaders header = createHeaders();
		RestTemplate restTemplate = getRestTemplate();
		HttpEntity<String> getBillDataEntity = new HttpEntity<String>(header);
		TXNAuditLogs auditLogs = new TXNAuditLogs();
